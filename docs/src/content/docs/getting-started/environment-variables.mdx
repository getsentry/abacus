...
| Variable | Description |
|----------|-------------|
| `OPENROUTER_MANAGEMENT_KEY` | OpenRouter Management API key (starts with `sk-or-v1-`). Powers both key provisioning and hourly usage sync. |

See [OpenRouter setup](/abacus/providers/openrouter/) for details.
